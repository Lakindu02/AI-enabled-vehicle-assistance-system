...
static const String baseUrl = 'http://YOUR_IP_HERE:8007';
// Example: static const String baseUrl = 'http://192.168.1.100:8007';
```
...
API URL: `http://localhost:8007` (default)

### Android Emulator

1. Start Android emulator from Android Studio
2. Update API URL to: `http://10.0.2.2:8007`
3. Run: `flutter run`
...
2. **Update API URL:**
   ```dart
   static const String baseUrl = 'http://192.168.1.100:8007';
   ```

3. **Ensure same WiFi network:**
   - Computer and phone must be on same network
   - Check firewall allows connections on port 8007
...
**Fix:**
1. Check API is running: `curl http://localhost:8007/`
...
4. Verify API is responding: `curl http://localhost:8007/`
