...
Future<Map<String, dynamic>> _processDamageAssessmentIsolate(
  ...
  for (int i = 0; i < imagePaths.length; i++) {
    ...
    request.fields['use_ai'] = (i == 0 && useAi) ? 'true' : 'false';
    ...
    if (response.statusCode == 200) {
      ...
      if (i == 0) {
        ...
        var affectedPart = result['part_mapping']['affected_part'];
        ...
        if (!combinedResult['part_mapping']['affected_part']
            .toString()
            .contains(affectedPart)) {
          combinedResult['part_mapping']['mapped_from'].add(affectedPart);
        }
      ...
      throw Exception('Assessment failed for image ${i + 1}: ${response.statusCode}');
    }
  }
